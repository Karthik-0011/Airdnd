    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, 2, 4, "chicago", "Chicago Loop Apartment", 250.0, "chicago_apt.jpg" },
                    { 2, 3, 4, 8, "atlanta", "Atlanta Suburban House", 320.0, "atlanta_house.jpg" },
                    { 3, 4, 5, 10, "miami", "Miami Beach House", 700.0, "miami_house.jpg" },
                    { 4, 1, 1, 2, "nyc", "NYC Studio", 180.0, "nyc_studio.jpg" }
                });
